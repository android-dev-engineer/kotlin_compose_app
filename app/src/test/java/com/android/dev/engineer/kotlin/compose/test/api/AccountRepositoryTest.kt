...
class AccountRepositoryTest {
    ...
    @Test
    fun `verify get new session http method`(): Unit = runBlocking {
    ...
    @Test
    fun `verify get new session url path`(): Unit = runBlocking {
        val bodyResponse = createNewSession().toJson()
        val mockResponse = MockResponse().setBody(bodyResponse)
        mockWebServer.enqueue(mockResponse)
        authenticationRepository.getNewSession(session = createSession())
    ...
    @Test
    fun `verify get new session request`(): Unit = runBlocking {
    ...
    @Test
    fun `verify get new session response`(): Unit = runBlocking {
